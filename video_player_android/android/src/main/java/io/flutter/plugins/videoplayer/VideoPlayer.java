...
final class VideoPlayer {
  ...
  VideoPlayer(
    ...
    Log.w("Console is:", options.toString());
    Log.w("Console is:", uri.toString());
    Log.w("Console is:", mediaSource.getMediaItem().mediaId);
    Log.w("Console is:", mediaSource.getMediaItem().toString());
    Log.w("Console is:", mediaSource.toString());
  ...
  VideoPlayer(
      ...
      EncryptedDataSource.Factory httpDataSourceFactory) {
    this.eventChannel = eventChannel;
    this.textureEntry = textureEntry;
    this.options = options;
